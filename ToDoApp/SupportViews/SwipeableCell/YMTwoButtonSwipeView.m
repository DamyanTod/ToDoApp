...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [leftButton setImage:[UIImage imageNamed:@"future"] forState:UIControlStateNormal];
        ...
        [middleButton setImage:[UIImage imageNamed:@"calendar_add"] forState:UIControlStateNormal];
        [middleButton setImageEdgeInsets: UIEdgeInsetsMake(10, 10, 10, 10)];
